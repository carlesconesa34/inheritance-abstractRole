 ...
 *
 * Each action consumes energy defined in Utils. The action is only
 * performed when the role is available and has sufficient energy.
 *
...
public class Soldier extends Role {
    ...
    /**
     * Moves the Soldier a fixed number of units along the X axis and
    ...
    /**
     * Returns a string representation of this Soldier, prefixed with
