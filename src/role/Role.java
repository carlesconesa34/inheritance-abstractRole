...
public abstract class Role {
    ...
    /**
     * Current energy level of the role, expressed as a percentage. Defaults to
     * 100. Certain actions consume energy; the role cannot perform them if it
    ...
    /**
     * Performs an extra horizontal movement, advancing the role 20.5 units
     * along the X axis and consuming 2 energy points.
     *
     * This action is only executed when the role is available and has at least
    ...
    /**
     * Performs an extra jump, advancing the role 25.2 units along the Y axis
     * and consuming 4 energy points.
     *
     * This action is only executed when the role is available and has at least
     ...
     *
     * @return true if the life was successfully decremented; false if the role
     * is unavailable or has no lives left
     */
     ...
     *
     * @return true if the life was successfully incremented; false if the role
     * is unavailable or already has three lives
     */
